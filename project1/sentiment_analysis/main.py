...
#-------------------------------------------------------------------------------
# Your code here
# fun = ['perceptron','average_perceptron','pegasos']
# theta, theta_0 = p1. pegasos(train_bow_features, train_labels, 25, 0.01)
# print('theta = ', [i for i in theta])
# print('theta_o = ',theta_0)
# print("arruracy = ", p1.accuracy(p1.classify(test_bow_features ,theta, theta_0), test_labels))
# test_bow_features
# test_labels
